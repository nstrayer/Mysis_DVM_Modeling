...
source("migrationProbCurve.r")
migrationProbability(40)
```
---
...
setMethod("nextTime","mysis", 
          function(object, foodRatio, time){       #Takes in the mysis object and the ratio of food quality at a given time. 
            ...
            sunrise = 7
            conditionCurve = 0.95 #hardcode value on condition curve, again fill value from model later. 

            if (time %% 24 == sunset + 1){ #if the mysis is in good condition use standard migration chance, if bad use 1 - chance
              
              if (migrationDraw > foodRatio) {
                object@migrating = migrationDraw_2 > conditionCurve 
                object@energy = object@energy - 50 #It costs enegry to swim up and down. 
              } else {
            ...
            #Old migration decision statements
