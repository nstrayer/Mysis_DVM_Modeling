...
stayVals = NULL
for (i in 1:5000){
migrateVals = c(migrateVals, rnorm(1,rewardUnits, rewardUnits*.5))
stayVals = c(stayVals, rnorm(1,(rewardUnits * ( 1 - foodRatio)), rewardUnits*.5) )
}

par(mfrow=c(1,2))
hist(migrateVals, main = "Migrate")
hist(stayVals, main = "Stay")
```
